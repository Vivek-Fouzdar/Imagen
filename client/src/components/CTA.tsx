            ...
            <div className="container mx-auto max-w-3xl">
                <div className="rounded-3xl bg-linear-to-b from-violet-900/20 to-violet-900/5 border border-violet-500/20 p-12 md:p-16 text-center relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        >
                            Ready to create AI-powered UGC ads?
                        </motion.h2>
                        ...
                        >
                            Create high-converting short ads and reel content using AI. Turn your ideas into engaging UGC videos in seconds.
                        </motion.p>
                        ...
                        >
                            <GhostButton className="px-8 py-3 gap-2">
                                Start Creating <ArrowRightIcon size={20} />
                            </GhostButton>
                        </motion.div>
