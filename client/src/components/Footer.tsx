        ...
        >
            <div className="max-w-6xl mx-auto px-6">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-white/10">
                    <div>
                        <img src={assets.logo} alt="favicon" className="h-8" />
                        <p className="max-w-[410px] mt-6 text-sm leading-relaxed">
                            Create high-converting AI UGC ads and reel content in seconds. Our platform helps brands, creators, and businesses generate engaging short-form videos effortlessly.
                        </p>
                    </div>
